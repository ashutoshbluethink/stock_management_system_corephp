				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-12">
							<h5 class="text-uppercase mb-0 mt-0 page-title">All Product</h5>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-12">
				...
				<div class="row">
					...
					<div class="col-sm-8 col-12 text-right add-btn-col">
						...
						<div class="view-icons">
							<a href="all-product.php" class="grid-view btn btn-link active"><i
									class="fas fa-th"></i></a>
							<a href="product-list.php" class="list-view btn btn-link"><i class="fas fa-bars"></i></a>
						</div>
					</div>
				</div>
						...
						<div class="profile-widget">
							...
							<div class="dropdown profile-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="edit-Product.html"><i
											class="fas fa-pencil-alt m-r-5"></i> Edit</a>
									<a class="dropdown-item" href="#" data-toggle="modal"
										data-target="#delete_employee"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
								</div>
							</div>
							<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="Product-profile.html"><?php echo $result['model_name']; ?></a></h4>
							<div class="medium text-muted">Rs<?php echo $result['price'] . " | " . $result['created_at']; ?></div>
							<div class="small text-muted"><?php echo $result['brand']; ?></div>
							<div class="small text-muted"><?php echo $result['comment']; ?></div>
							
								<a href="backend/product_status.php?product_id_grid=<?php echo $result['product_id']; ?>">
