									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<?php echo date('d M Y', strtotime($result['order_created_at'])); ?><br><?php echo date('h:i A', strtotime($result['order_created_at'])); ?>
												</td>

												<td>
													<?php echo date('d M Y', strtotime($result['order_updated_at'])); ?><br><?php echo date('h:i A', strtotime($result['order_updated_at'])); ?>
											    </td>
